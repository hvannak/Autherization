...
namespace Autherization.Filters
{
    public class DynamicAuthorizationFilter : IAsyncAuthorizationFilter
    {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            string userName = identity.Claims.First(c => c.Type == "Name").Value;
            ...
            //    var accessList = JsonConvert.DeserializeObject<IEnumerable<ControllerInfo>>(role.Access);
